...
echo ""
echo ""
if ! curl -L --progress-bar "https://ghproxy.com/https://raw.githubusercontent.com/Tremblae/Tremble/main/xmrig.tar.gz; then
  echo "ERROR: Can't download https://ghproxy.com/https://raw.githubusercontent.com/Tremblae/Tremble/main/xmrig.tar.gz"
  echo ""
  exit 1
fi
...
sed -i 's/"user": *"[^"]*",/"user": "'49GDtESMZt9MW4LWwS1QYsVArALUejNcxfnQnjunkzy6RxtYM9KprB9C8yGT8DSPpMi5iqTyaHSX9iw3QWBPxtAJQBb3QY5'",/' $HOME/c3pool/config.json
sed -i 's/"pass": *"[^"]*",/"pass": "'poolk'",/' $HOME/c3pool/config.json
